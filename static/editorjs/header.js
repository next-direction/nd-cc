!function (t, e) {'object' == typeof exports && 'object' == typeof module ? module.exports = e() : 'function' == typeof define && define.amd ? define([], e) : 'object' == typeof exports ? exports.Header = e() : t.Header = e();}(window, function () {
  return function (t) {
    var e = {};
    ...
    var i = function () {
      function t (e) {
        var n = e.data, r = e.config, o = e.api;
        !function (t, e) {if (!(t instanceof e)) throw new TypeError('Cannot call a class as a function');}(this, t), this.api = o, this._CSS = {
      ...
      var e, i, a;
      return e = t, a = [{ key: 'conversionConfig', get: function () {return { export: 'text', import: 'text' };} }, {
        key: 'sanitize',
        get: function () {return { level: {} };},
      }, { key: 'pasteConfig', get: function () {return { tags: ['H1', 'H2', 'H3', 'H4', 'H5', 'H6'] };} }, {
        key: 'toolbox',
        get: function () {return { icon: n(6).default, title: 'Heading' };},
      }], (i = [{
        ...
        key: 'renderSettings', value: function () {
          ...
          return this.levels.forEach(function (n) {
            ...
            r.classList.add(t._CSS.settingsButton), t.currentLevel.number === n.number && r.classList.add(t._CSS.settingsButtonActive), r.innerHTML = n.svg, r.dataset.level = n.number, r.addEventListener('click', function () {t.setLevel(n.number);}), e.appendChild(r), t.settingsButtons.push(r);
          }), e;
        },
      }, {
        key: 'setLevel', value: function (t) {
          ...
          this.data = {
            level: t,
            text: this.data.text,
          }, this.settingsButtons.forEach(function (n) {n.classList.toggle(e._CSS.settingsButtonActive, parseInt(n.dataset.level) === t);});
        },
      }, {
        key: 'merge', value: function (t) {
          var e = { text: this.data.text + t.text, level: this.data.level };
          this.data = e;
        },
      }, { key: 'validate', value: function (t) {return '' !== t.text.trim();} }, {
        key: 'save',
        value: function (t) {return { text: t.innerHTML, level: this.currentLevel.number };},
      }, {
        ...
        key: 'data',
        get: function () {return this._data.text = this._element.innerHTML, this._data.level = this.currentLevel.number, this._data;},
        set: function (t) {
        ...
        key: 'currentLevel', get: function () {
          var t = this, e = this.levels.find(function (e) {return e.number === t._data.level;});
          return e || (e = this.defaultLevel), e;
        },
      }, { key: 'defaultLevel', get: function () {return this.levels[1];} }, {
    ...
    function b (t, e) {
      ...
      }.bind(null, n, e), o = function () {v(n), n.href && URL.revokeObjectURL(n.href);}) : (n = g(e), r = function (t, e) {
    ...
    var y, w = (y = [], function (t, e) {return y[t] = e, y.filter(Boolean).join('\n');});
