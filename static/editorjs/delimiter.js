!function (e, t) {'object' == typeof exports && 'object' == typeof module ? module.exports = t() : 'function' == typeof define && define.amd ? define([], t) : 'object' == typeof exports ? exports.Delimiter = t() : e.Delimiter = t();}(window, function () {
  return function (e) {
    var t = {};
    ...
    var i = function () {
      function e (t) {
        ...
        !function (e, t) {if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');}(this, e), this.api = r, this._CSS = {
          block: this.api.styles.block,
          wrapper: 'ce-delimiter',
        }, this._data = {}, this._element = this.drawView(), this.data = n;
      }

      return o(e, null, [{ key: 'contentless', get: function () {return !0;} }]), o(e, [{
        key: 'drawView', value: function () {
          var e = document.createElement('DIV');
          return e.classList.add(this._CSS.wrapper, this._CSS.block), e;
        },
      }, { key: 'render', value: function () {return this._element;} }, { key: 'save', value: function (e) {return {};} }], [{
        key: 'toolbox',
        get: function () {
          return {
  ...
  }, function (e, t, n) {(e.exports = n(3)(!1)).push([e.i, '.ce-delimiter {\n    line-height: 1.6em;\n    width: 100%;\n    text-align: center;\n}\n\n.ce-delimiter:before {\n    display: inline-block;\n    content: "***";\n    font-size: 30px;\n    line-height: 65px;\n    height: 30px;\n    letter-spacing: 0.2em;\n}', '']);}, function (e, t) {
    ...
    function y (e, t) {
      ...
      }.bind(null, n, t), o = function () {v(n), n.href && URL.revokeObjectURL(n.href);}) : (n = b(t), r = function (e, t) {
    ...
    var g, w = (g = [], function (e, t) {return g[e] = t, g.filter(Boolean).join('\n');});
