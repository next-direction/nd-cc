class CodePlugin {
  ...
  render () {
    ...
    this.modeDisplay.classList.add('code-plugin-mode');
    this.modeDisplay.innerText = currentMode;

    this.wrapper.appendChild(this.modeDisplay);
  ...
  renderSettings () {
    ...
    select.classList.add('ce-settings__code-plugin-mode');
